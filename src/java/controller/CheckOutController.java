...
public class CheckOutController extends HttpServlet {
    ...
    private final String CHECK_OUT_SUCCESS = "orders.jsp";
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String shipID = request.getParameter("txtShipID");
        LocalDate localDate = LocalDate.now();
    Date OrderDate = Date.from(localDate.atStartOfDay().atZone(ZoneId.systemDefault()).toInstant());
...
//        String OrderDate = currentDate.format(formatter);
        ...
        try  {
            ...
            if (cartList != null) {
                  ...
                  boolean result = dao.createOrder(OrderDate, totalPrice, username, productID, shipID, cart);
                    if (result) {
                                    // Order successfully
