...
<!--                        <p>SHIPPING</p>
     ...
     <c:if test="${not empty sessionScope.username}">
                Username: <input type="hidden" name="txtUsername" 
                                  value="${cust.username}" /> <br/>
               ${cust.username}
                </c:if>
   ...
   <c:if test="${not empty custname}">
               ...
               ${sessionScope.custname}
                </c:if>
                Ship ID: <input type="text" name="txtShipID" 
                                  value="" /> <br/>
                
                Order_Date:  ${requestScope.OrderDate}


Delivery_Date: <input type="date" name="delivery" 
                                  value="" /> <br/>
  ...
  <!------------------------------------------------------------------------->      
     ...
     <c:if test="${not empty sessionScope.username}">
               ...
               ${cust.username}
                ...
                <c:set var="custname" value="${sessionScope.custName}" />
   <c:if test="${not empty custname}">
                Username: <input type="hidden" name="txtCustname" 
                                  value="${sessionScope.custname}" /> <br/>
               ${sessionScope.custname}
                </c:if>
                Ship ID: <input type="text" name="txtShipID" 
                                  value="" /> <br/>
