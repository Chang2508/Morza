      ...
      <form action="listProduct">
        <a href="#" class="text-decoration-none text-dark col-lg-3 col-md-6 mb-4" data-toggle="modal" data-target="#myitemsModal">
         <img src="data:image/jpg    ;base64,${img.base64ImageData}"  width="200px" height="200px"/>
          ...
          <p class="small mb-2"><span class="badge badge-light ml-auto"><i class='fas fa-dollar-sign'></i> ${img.price}</span> <i class="mdi mdi-silverware-fork-knife ml-2 mr-1"></i> ${img.categoryName}  <i class="mdi mdi-motorbike ml-2 mr-2"></i>Freeship</p>
        </a>
      </form>
